...
export const uiPt: Record<string, string> = {
  ...
  "We still have little evidence about this skill.": "Ainda temos poucos dados sobre essa habilidade.",
  "This is your lowest skill score right now.": "Esta é a sua menor pontuação por habilidade agora.",
  ...
  "Start anywhere and we will personalise your next step.": "Comece por onde quiser e personalizamos seu próximo passo.",
