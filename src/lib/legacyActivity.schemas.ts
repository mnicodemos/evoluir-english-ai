...
export const quizLegacyInputSchema = z
  .object({
...
export const listeningLegacyInputSchema = z
  .object({
    operationKey,
...
export const pronunciationLegacyInputSchema = z
  .object({
    operationKey,
...
export const talkingLegacyInputSchema = z
  .object({
    operationKey,
