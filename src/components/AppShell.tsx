    ...
    <TooltipProvider delayDuration={200}>
      <div
        className={cn(
          ...
          dashboardLayout ? "dashboard-shell dark lg:pl-[13.5rem]" : "lg:pl-20",
        )}
      >
        <aside
          className={cn(
            ...
            dashboardLayout
              ? "dashboard-sidebar w-[13.5rem] items-stretch px-2.5 pt-3.5 pb-3"
              : "w-20 items-center",
          )}
        >
          <Link
            ...
            className={cn(
              ...
              dashboardLayout
                 ? "flex h-14 min-w-0 items-center gap-3 px-2.5"
          ...
          >
            ...
            {dashboardLayout && (
              <span className="min-w-0 whitespace-nowrap leading-none">
                ...
                <span className="mt-1 block text-[11px] font-semibold uppercase text-sidebar-foreground/65">
                  English AI
                </span>
              </span>
            )}
            ...
            {(dashboardLayout ? dashboardSidebarNav : sidebarNav).map((item) => (
              <Tooltip key={item.to}>
                <TooltipTrigger asChild>
                  ...
                  >
                    <item.icon className="size-5 stroke-[2.15]" />
                    {dashboardLayout && (
