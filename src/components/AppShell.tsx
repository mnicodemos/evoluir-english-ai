    ...
    <TooltipProvider delayDuration={200}>
      <div
        className={cn(
          ...
          dashboardLayout ? "dashboard-shell dark lg:pl-[14.25rem]" : "lg:pl-20",
        )}
      >
        <aside
          className={cn(
            ...
            dashboardLayout
              ? "dashboard-sidebar w-[14.25rem] items-stretch px-2.5 pt-4 pb-4"
              : "w-20 items-center",
          )}
        >
          <Link
            ...
            className={cn(
              ...
              dashboardLayout
                 ? "flex h-14 min-w-0 items-center gap-3 px-3"
          ...
          >
            ...
            {dashboardLayout && (
              <span className="min-w-0 whitespace-nowrap leading-none">
                ...
                <span className="mt-1 block text-[11px] font-semibold uppercase tracking-wide text-sidebar-foreground/65">
                  English AI
                </span>
              </span>
            )}
          ...
          <nav className={cn("flex flex-1 flex-col", dashboardLayout ? "mt-2 gap-1" : "mt-8 gap-1.5")}>
                ...
                <TooltipTrigger asChild>
                  <Link
                    ...
                    className={cn(
                      ...
                      dashboardLayout
                        ? "dashboard-sidebar-link -mx-1 grid h-[2.7rem] grid-cols-[2.1rem_minmax(0,1fr)] items-center px-2.5 text-sm font-medium"
                  ...
                  >
                    <item.icon className="size-[1.3rem] stroke-[2.15]" />
                    {dashboardLayout && (
              ...
              <>
                ...
                {dashboardAccountNav.map((item) => (
                  <Link
                    ...
                    to={item.to}
                    aria-label={translate(item.label)}
                    className="dashboard-sidebar-link -mx-1 grid h-[2.7rem] grid-cols-[2.1rem_minmax(0,1fr)] items-center rounded-lg px-2.5 text-sm font-medium text-sidebar-foreground/70 transition-colors hover:bg-sidebar-accent hover:text-sidebar-foreground"
                    activeProps={{
                      className:
                        "border border-brand-green/35 bg-sidebar-accent text-sidebar-foreground shadow-[inset_3px_0_0_var(--brand-green)]",
                    }}
