...
export function AiTeacherFloatButton({ className }: { className?: string }) {
  return (
    <Link
      ...
      className={cn(
        "fixed bottom-[4.5rem] right-4 z-40 grid size-14 place-items-center rounded-full transition-transform duration-200 hover:scale-110 lg:bottom-8 lg:right-8",
        className
      )}
      style={{
