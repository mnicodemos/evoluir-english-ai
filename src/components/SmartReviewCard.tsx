...
export function SmartReviewCard({
  ...
  if (compact) {
    return (
      <section className="card-soft flex h-full min-w-0 flex-col p-3" aria-labelledby="smart-review-title">
        ...
        <ul className="mt-2.5 grid flex-1 grid-rows-2 gap-1.5 overflow-hidden">
