  ...
  return (
    <AppShell dashboardLayout>
      {isLoading || !profile ? (
        ...
        <div className="dashboard-one-screen grid gap-3 xl:h-[calc(100vh-1.5rem)] xl:grid-rows-[3.75rem_6.25rem_17.333rem_minmax(9.25rem,0.85fr)_minmax(5.75rem,0.45fr)] xl:gap-2.5">
          ...
          <div className="order-5 card-soft grid min-w-0 overflow-hidden sm:grid-cols-2 lg:order-none lg:grid-cols-4 xl:h-[6.75rem] [&>*+*]:border-border sm:[&>*+*]:border-l">
            ...
            <div className="grid min-w-0 grid-cols-[minmax(0,1fr)_auto] items-center gap-3">
              <div className="flex items-center gap-2">
                 <span className="grid size-8 place-items-center text-warning">
                   <Bolt className="size-6 text-warning" strokeWidth={2.6} aria-hidden="true" />
                </span>
