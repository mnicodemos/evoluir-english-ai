  ...
  return (
    <AppShell dashboardLayout>
      {isLoading || !profile ? (
        ...
        <div className="dashboard-one-screen grid gap-2.5 xl:h-[calc(100vh-1rem)] xl:grid-rows-[4rem_5.75rem_17.333rem_minmax(9.5rem,1fr)_minmax(7rem,0.72fr)] xl:gap-5">
